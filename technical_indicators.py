...
List of indicators implemented:
1. Relative Strength Index (RSI)
2. Williams %R
3. Volatility (20-day and 60-day)
4. Trend indicators (1-3, 5-20, 20-60)
5. Average True Range (ATR)
6. MACD (Moving Average Convergence Divergence)
7. TRIX (Triple Exponential Moving Average Oscillator)
8. Commodity Channel Index (CCI)
9. Chande Momentum Oscillator (CMO)
10. Ichimoku Cloud components
11. Know Sure Thing (KST)
12. Ultimate Oscillator
13. Aroon Indicator
14. Stochastic Oscillator
15. On-Balance Volume (OBV)
16. Ease of Movement (EMV)
17. Chaikin Money Flow (CMF)
18. Accumulation/Distribution Index (A/D)
19. Volume feature (raw volume data)

TO-DO: Cross-sectional momentum.
"""
